...
### Funcionalidades:
- Exibir nome do programa com arte ASCII
- Menu interativo com opções
- Cadastro de restaurantes
- Listagem de restaurantes
- Alternar estado (ativo/desativado)
- Controle de fluxo via funções
...
- Classificar idade (criança, adolescente ou adulto)
- Simular verificação de usuário e senha
- Identificar o quadrante de um ponto no plano cartesiano
...
### Funcionalidades:
- Percorrer listas de números, nomes e anos
- Somar apenas números ímpares
...
- Índices de listas
- len()
- Tratamento de exceções (TypeError, ZeroDivisionError)
- Retorno de valores
